   ...
   <div id="layoutSidenav">
     ...
     <div id="layoutSidenav_content">
      ...
      <div class="row mt-2 p-3 bg-light" >
            <div class="col-6">
               <h3>Request Food Order Details</h3>
            </div>
            <div class="col-6 text-right">
                <a href="Managecfood" class="btn btn-success text-white">
                    <i class='fa fa-plus-square' style='font-weight: 700; padding: 4px'> Add food item</i>
                </a>
         ...
         <div class="row table-responsive">
            <div class="col-md-12">
               ...
               $email=$_SESSION["email"];
                 $rs=mysqli_query($conn,"select *from cfood where status='N' and email='$email' order by item_id desc")                   
