...
<!DOCTYPE html>
  <html>
   ...
   <head>
      ...
      <title>Dashboard - Reject Details</title>
   ...
   <div id="layoutSidenav">
     ...
     <div id="layoutSidenav_content">
      ...
      <div class="row mt-2 p-3 bg-light" >
            <div class="col-6">
               <h3>Reject Food Order Details</h3>
            </div>
...
<!-- report deatils  -->
         ...
         <div class="row table-responsive">
            <div class="col-md-12">
               <?php
                 $rs=mysqli_query($conn,"select *from cfood where status='R' order by item_id desc")                   
